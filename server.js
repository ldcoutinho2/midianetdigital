  ...
  try {
    ...
    if (combo) {
      ...
      for (const pub of pubs) {
        ...
        if ((expectedLikes > 0 && likes > 0 && likes < 150) || (expectedViews > 0 && views > 0 && views < 150)) {
          return res.status(400).json({ error: 'Cada publicacao precisa receber no minimo 150 curtidas e/ou 150 visualizacoes quando esse componente estiver contratado' });
        }
      }
